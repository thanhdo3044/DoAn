...
namespace backend.Controllers
{
    public class NguoiBansController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetNguoiBan(string id)
        {
        ...
        public async Task<IHttpActionResult> PutNguoiBan(string id, NguoiBan nguoiBan)
        {
        ...
        [ResponseType(typeof(NguoiBan))]
        public async Task<IHttpActionResult> DeleteNguoiBan(string id)
        {
            NguoiBan nguoiBan = await db.NguoiBans.FindAsync(id);
            if (nguoiBan == null)
            {
        ...
        private bool NguoiBanExists(string id)
        {
